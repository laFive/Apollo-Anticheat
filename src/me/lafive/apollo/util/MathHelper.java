...
public class MathHelper {
	...
	public static double lowestAbs(float n, float n2) {
	...
	public static Double getMinimumAngle(final PacketLocation packetLocation, final PacketLocation... array) {
        Double value = null;
        for (final PacketLocation playerLocation : array) {
            final double distanceBetweenAngles360 = getDistanceBetweenAngles360(playerLocation.getYaw(), (float) (Math.atan2(packetLocation.getPosZ() - playerLocation.getPosZ(), packetLocation.getPosX() - playerLocation.getPosX()) * 180.0 / 3.141592653589793) - 90.0f);
